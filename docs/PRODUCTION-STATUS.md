...
The latest GitHub validation completed successfully: dependency install, TypeScript type-check, formatting, lint and production build all passed. The creation surface now also accepts source audio and a reference voice for supported voice-swap/stem routes.