...
const required = [
  ...
  ["gateway uploads the actual reference Blob", files.gateway, "const audio = new Blob([decodeBase64(audioBase64)]"],
  ["gateway uploads through the Qwen file endpoint", files.gateway, "qwenUpload(space, audio, env)"],
  ...
  ["gateway uses the fallback Qwen operation", files.gateway, '"handle_generate"'],
