...
console.log("Buddy voice path verified: actual reference Blob -> content-hashed cached base64 -> /api/voice-clone -> Qwen3-TTS 1.7B Base full reference conditioning -> returned Blob -> normalizeAndVerifyBrowserAudio() -> validated normalized browser URL; obsolete local Chatterbox production path rejected.");
