        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.24em] sm:text-xs">
                Buddy is ready
              </span>
            </div>
            <h1 className="mt-5 max-w-2xl font-display text-[clamp(2.25rem,9vw,4.5rem)] font-black leading-[0.94] tracking-tight text-white drop-shadow-2xl">
          ...
          <div
            className="buddy-stage relative mx-auto w-40 shrink-0 sm:w-48 lg:mx-0 lg:w-56"
            aria-label="Animated Buddy character"
          >
            ...
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-2xl border border-white/10 bg-black/85 px-3 py-2 shadow-xl backdrop-blur-md">
              <StudioLogo compact />
            </div>
            <span className="absolute -right-1 top-3 rounded-full border border-primary/40 bg-black/75 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-primary backdrop-blur-md">
              Buddy
            </span>
          </div>
        </div>
          ...
          {TASKS.map(({ task, title, copy }) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "group min-h-24 rounded-2xl border border-white/10 bg-black/40 p-3.5 text-left shadow-lg backdrop-blur-xl transition-all duration-200 hover:-translate-y-1 hover:border-primary/50 hover:bg-primary/10 hover:shadow-[0_12px_35px_oklch(0.55_0.22_25_/_0.16)] active:scale-[0.985]",
