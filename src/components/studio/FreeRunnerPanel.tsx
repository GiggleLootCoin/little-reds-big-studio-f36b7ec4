  ...
  return (
    ...
    >
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {index === 0 && <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-semibold text-primary">Best free route</span>}
                </div>
      ...
      <p className="text-[11px] text-muted-foreground">
        Keep the Studio open while a public GPU runner works, then import the finished file back into your project.
        Public free GPU availability can change, so the runtime validates the result and falls back when possible.
      </p>
    </Panel>
  );
}