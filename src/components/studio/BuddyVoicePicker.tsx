...
const FRIENDLY_CLONE_FAILURE =
  "I couldn't make that voice sample just yet. Your sample is safe. Want to try again?";
const FRIENDLY_VOICE_FAILURE =
  "Buddy couldn't get that voice ready just yet. Want to try another voice?";
  ...
  const uploadClone = async (file: File) => {
    ...
    try {
      ...
      try {
        ...
        /* clone can continue without a transcript */
      }
      update({
        mode: "clone",
