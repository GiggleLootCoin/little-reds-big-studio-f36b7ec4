    ...
    <div className="relative min-h-[100svh] overflow-x-clip">
      ...
      {loading && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center gap-5 bg-background/95 px-6 text-center backdrop-blur-xl">
          <StudioLogo />
          <div className="h-1 w-44 max-w-full overflow-hidden rounded-full bg-secondary"><div className="gloss-sheen crimson-gloss h-full w-full" /></div>
          <p className="font-display text-[0.62rem] font-semibold tracking-[0.24em] text-primary">{VERSION}</p>
        </div>
      )}
        ...
        {tab === "home" && (
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1.35fr)_minmax(300px,0.65fr)] lg:items-start">
              ...
              <section className="rounded-2xl border border-border/60 bg-background/45 p-4 backdrop-blur-md sm:p-5"><h2 className="font-display text-sm font-bold uppercase tracking-[0.18em]">Your project</h2><p className="mt-1 text-xs leading-5 text-muted-foreground">Start anywhere. Buddy keeps the workflow moving while the engine deck gives you direct free fallbacks.</p><div className="mt-4 flex flex-wrap gap-2"><Chip>Android-first</Chip><Chip>Free/open</Chip><Chip>Buddy-led</Chip></div></section>
            </div>
