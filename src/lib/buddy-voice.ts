...
export const BUDDY_VOICE_PRESETS = [
  { id: "Ryan", label: "Marlowe", note: "English • smoky, intimate, confident" },
  { id: "Aiden", label: "Calder", note: "English • warm, sunny, effortless" },
  { id: "Vivian", label: "Saffron", note: "Multilingual • bright, crisp, animated" },
  { id: "Serena", label: "Maeve", note: "Multilingual • soft, husky, relaxed" },
  { id: "Uncle_Fu", label: "Silas", note: "Multilingual • deep, grounded, direct" },
  { id: "Dylan", label: "Juno", note: "Multilingual • playful, punchy, fearless" },
  { id: "Eric", label: "Rafe", note: "Multilingual • bold, dramatic, commanding" },
  { id: "Ono_Anna", label: "Aiko", note: "Japanese • delicate, curious, expressive" },
  { id: "Sohee", label: "Nari", note: "Korean • warm, intimate, reflective" },
] as const;
