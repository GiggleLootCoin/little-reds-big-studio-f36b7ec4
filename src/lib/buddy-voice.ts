...
export const BUDDY_VOICE_PRESETS = [
  { id: "Ryan", label: "Velvet Riot", note: "English • smoky, intimate, confident" },
  { id: "Aiden", label: "Golden Hour", note: "English • warm, sunny, effortless" },
  { id: "Vivian", label: "Neon June", note: "Multilingual • bright, crisp, animated" },
  { id: "Serena", label: "Sunday Static", note: "Multilingual • soft, husky, relaxed" },
  { id: "Uncle_Fu", label: "Black Coffee", note: "Multilingual • deep, grounded, direct" },
  { id: "Dylan", label: "Cherry Bomb", note: "Multilingual • playful, punchy, fearless" },
  { id: "Eric", label: "Fire Escape", note: "Multilingual • bold, dramatic, commanding" },
  { id: "Ono_Anna", label: "Paper Moon", note: "Japanese • delicate, curious, expressive" },
  { id: "Sohee", label: "Blue Moon", note: "Korean • warm, intimate, reflective" },
] as const;
