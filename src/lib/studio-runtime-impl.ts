...
async function runChatterbox(cl: Client, input: StudioJobInput): Promise<StudioArtifact> {
  ...
  // Current ResembleAI/Chatterbox /generate_tts_audio has six inputs:
  // text, reference audio, exaggeration, temperature, seed, CFG weight.
  // Do not use the old seventh VAD argument.
  ...
  throw last instanceof Error ? last : new Error("Chatterbox clone generation failed");
}
