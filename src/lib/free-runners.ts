...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    capabilities: ["tts"],
    url: "/api/ai/tts",
    notes: "Preferred preset route; browser speech remains the final device fallback.",
    priority: 500,
  },
  {
    id: "hf-chatterbox-v3",
  ...
  },
  {
    ...
    notes: "Do not rely on this route; its public ZeroGPU capacity may be exhausted.",
    priority: 120,
  },
  {
    id: "hf-seed-vc",
