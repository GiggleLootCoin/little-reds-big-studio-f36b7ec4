 ...
 * browser. Public Spaces are machinery, not guarantees: runtime code must
 * discover the live schema, execute a compatible job, validate the artifact,
 * and fail over when a route is sleeping, saturated or incompatible.
 */
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    name: "Qwen3 Omni",
    kind: "public",
    description: "Official Qwen3 Omni multimodal assistant fallback for text, audio, image and video conversation.",
  ...
  },
  {
    ...
    name: "Qwen3 WebGPU",
    kind: "android",
    description: "Browser-local Qwen3 reasoning and writing on capable Android WebGPU devices.",
    capabilities: ["text", "writing", "lyrics"],
    url: "https://huggingface.co/spaces/webml-community/qwen3-webgpu",
    notes: "Optional device-local fallback. No Colab or separate computer is required.",
    priority: 125,
  },
  {
    id: "hf-ace-step-15",
  ...
  },
  {
    ...
    notes: "Strong free full-song fallback with live API discovery required.",
    priority: 145,
  },
  {
    id: "hf-ace-step",
  ...
  },
  {
    ...
    name: "Qwen3-TTS",
    kind: "public",
    description: "Natural multilingual speech, voice design, reference-voice cloning and preset voices.",
    capabilities: ["voice", "voice-clone", "tts", "multilingual-tts"],
    url: "https://huggingface.co/spaces/Qwen/Qwen3-TTS",
    notes: "Official Qwen Space; live schema discovery is mandatory.",
    priority: 175,
  },
  {
    id: "hf-moss-tts-15",
    name: "MOSS-TTS v1.5",
    kind: "public",
    description: "Open multilingual TTS with zero-shot voice cloning and long-form speech.",
    capabilities: ["voice", "voice-clone", "tts", "multilingual-tts"],
    url: "https://huggingface.co/spaces/OpenMOSS-Team/MOSS-TTS-v1.5",
    notes: "Independent voice fallback; live schema discovery required.",
    priority: 155,
  },
  {
    ...
    notes: "Independent high-quality voice fallback.",
    priority: 150,
  },
  {
    id: "hf-seed-vc",
  ...
  },
  {
    ...
    notes: "Advanced RVC fallback; live API capability discovery is mandatory.",
    priority: 135,
  },
  {
    id: "hf-ai-rvc",
  ...
  },
  {
    ...
    name: "Qwen3-ASR",
    kind: "public",
    description: "Official Qwen speech recognition with transcription and timestamps.",
    capabilities: ["speech-to-text", "transcription", "realtime-asr"],
    url: "https://huggingface.co/spaces/Qwen/Qwen3-ASR",
    notes: "Primary modern ASR candidate; live endpoint compatibility is checked before selection.",
    priority: 170,
  },
  {
  ...
  },
  {
    ...
    kind: "public",
    description: "High-quality speech recognition for recorded audio and captions.",
  ...
  },
  {
    ...
    notes: "Fast fallback for English speech.",
    priority: 120,
  },
  {
    id: "hf-qwen-image",
    name: "Qwen Image",
    kind: "public",
    description: "Official Qwen image generation for artwork and covers.",
    capabilities: ["image", "artwork", "cover"],
    url: "https://huggingface.co/spaces/Qwen/Qwen-Image",
    notes: "Live schema discovery and artifact validation required.",
    priority: 175,
  },
  {
    ...
    kind: "public",
    description: "Official Qwen natural-language image editing and transformation.",
    capabilities: ["image", "image-edit", "artwork", "cover"],
    url: "https://huggingface.co/spaces/Qwen/Qwen-Image-Edit",
    notes: "Use when an input image is supplied; live schema discovery handles exact inputs.",
    priority: 170,
  },
  {
    id: "hf-z-image",
  ...
  },
  {
    ...
    name: "SDXL Turbo",
    kind: "public",
    description: "Mature open image-generation and editing fallback.",
  ...
  },
  {
    ...
    kind: "public",
    description: "Open video generation with synchronized generated audio.",
    ...
    notes: "Primary free video route; live API compatibility is required.",
    priority: 170,
  },
  {
    id: "hf-wan-22-fast",
    name: "Wan 2.2 Fast",
    kind: "public",
    description: "High-quality open image-to-video generation optimized for shared GPU inference.",
    ...
    notes: "Public Wan2.2 fallback; live API discovery is mandatory.",
    priority: 165,
  },
  {
    ...
    notes: "Fallback only when stronger video routes are unavailable.",
    priority: 120,
  },
  {
    id: "hf-demucs",
    ...
    notes: "Useful component for song cleanup and voice-conversion workflows.",
    priority: 125,
  },
  {
    id: "hf-kokoro",
    ...
    notes: "Fast local Android/browser fallback when remote voice services are unavailable.",
    priority: 105,
  },
];
