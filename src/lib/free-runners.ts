...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    notes: "Free fallback when the Cloudflare image route is unavailable.",
    priority: 80,
  },
  {
    id: "cf-seedance-fast",
    ...
    url: "/api/ai/video",
    notes: "Server route; used only after free public video routes are attempted.",
    priority: 100,
  },
  {
    ...
    notes: "Free route; live Gradio schema and playable video are required.",
    priority: 80,
  },
  {
    id: "hf-demucs",
