...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    kind: "public",
    description: "Primary real reference-voice cloning engine from Resemble AI.",
    capabilities: ["voice-clone", "tts"],
    url: "https://huggingface.co/spaces/ResembleAI/Chatterbox",
    notes:
      "Uses the official Chatterbox reference-audio input. Transcript is optional because Chatterbox clones from the audio prompt directly.",
    priority: 900,
  },
  {
    id: "hf-qwen3-tts",
    name: "Qwen3-TTS Voice Base",
    kind: "public",
    description: "High-quality Qwen reference-voice cloning fallback.",
    capabilities: ["tts", "voice-clone"],
    url: "https://huggingface.co/spaces/Qwen/Qwen3-TTS",
    notes:
      "Secondary clone route. Uses the real Qwen3-TTS Base model when the public Chatterbox route is unavailable.",
    priority: 800,
  },
  {
    id: "hf-chatterbox-v3",
    ...
    kind: "public",
    description: "Multilingual reference-voice cloning fallback.",
