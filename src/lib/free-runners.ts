...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    url: "/api/ai/tts",
    notes: "Cheap first choice; server automatically fails over to Aura-2 then Aura-1.",
    priority: 300,
  },
  {
    id: "cf-aura-2",
    ...
    kind: "gpu",
    description: "Natural TTS failover when MeloTTS is unavailable.",
    capabilities: ["voice", "tts"],
    url: "/api/ai/tts",
    notes: "Server-side Deepgram Aura-2 fallback.",
    priority: 295,
  },
  {
    id: "cf-whisper",
