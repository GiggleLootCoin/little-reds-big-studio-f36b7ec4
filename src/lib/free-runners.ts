...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    notes: "Live schema and real artifact required.",
    priority: 160,
  },
  {
    id: "hf-diffrhythm2",
  ...
  },
  {
    ...
    name: "ACE-Step",
    kind: "public",
    description: "Additional song-generation fallback.",
  ...
  },
  {
    ...
    kind: "gpu",
    description: "Real server-side Buddy speech generation.",
    capabilities: ["voice", "tts", "multilingual-tts"],
    url: "/api/ai/tts",
    notes: "Uses Cloudflare's hosted MeloTTS; no reference audio required for normal speech.",
    priority: 300,
  },
  {
    id: "hf-moss-tts-15",
  ...
  },
  {
    ...
    name: "LTX Video Fast",
    kind: "gpu",
    description: "Real text-to-video fallback using LTX Video Fast.",
    capabilities: ["video", "video-generation", "image-to-video"],
    url: "https://huggingface.co/spaces/Lightricks/ltx-video-distilled",
    notes: "Running ZeroGPU Space; live schema and actual video artifact required.",
    priority: 190,
  },
  {
    id: "hf-wan22-fast",
    ...
    kind: "gpu",
    description: "Image-to-video animation fallback for Buddy and artwork.",
    capabilities: ["video", "video-generation", "image-to-video", "animation"],
    url: "https://huggingface.co/spaces/zerogpu-aoti/Wan2.2-14B-Fast",
    notes: "Live ZeroGPU Space; requires compatible image input for I2V.",
    priority: 180,
  },
  {
    id: "hf-demucs",
