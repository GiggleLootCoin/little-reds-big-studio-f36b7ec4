...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    name: "EchoForge 23",
    kind: "public",
    description: "Natural multilingual reference-voice cloning fallback.",
    capabilities: ["voice-clone"],
    url: "https://huggingface.co/spaces/ResembleAI/Chatterbox-Multilingual-TTS-V3",
    notes: "Secondary clone route only after Qwen fails. Authorized reference audio only.",
    priority: 600,
  },
  {
    id: "hf-chatterbox",
    ...
    notes: "Secondary English clone route only after stronger clone routes fail.",
    priority: 500,
  },
  {
    id: "hf-cosyvoice3",
