...
const ROUTES: Record<string, BuddyModelRoute> = {
  qwen: {
    id: "qwen3",
...
export function hasVisionInput(input: Record<string, unknown>): boolean {
...
export function selectBuddyModel(input: Record<string, unknown>): BuddyModelRoute {
...
export function buddyModelCatalog(): BuddyModelRoute[] {
